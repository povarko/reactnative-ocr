...
class AddBlogScreen extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      imageSource: null,
          ...
          <View style={{ flex: 1 }}>
            <View style={styles.header}>
              ...
              <View style={{ flexDirection: "row" }}>
                <Text style={styles.textTitle}>STEP 4: </Text>
                <Text style={styles.textTitle1}>
                  {type === "TEAM" ? "ADD TEAM BLOG" : "ADD BLOG"}
                </Text>
              </View>
              <View style={{ width: 20 }} />
            </View>
            <View style={styles.header2}>
              ...
              <Text
                style={[
                  ...
                  { fontSize: 12, marginLeft: wp("40%"), marginBottom: 20 }
                ]}
              >
                80%
              </Text>
              ...
              <View style={styles.bodyContent}>
                <View style={styles.bioContent}>
                  ...
                  <View style={{ marginTop: 10 }}>
                    <Text>CREATE NEW BLOG ARTICLE</Text>
                  </View>
                  <View style={{ marginTop: 10 }}>
                    <Input
                ...
                >
                  ...
                  >
                    <Text style={styles.helpSupportText}>Add More Blogs</Text>
                    <FontAwesome5
                      solid
                      name="plus-square"
                      style={{
            ...
            <View style={styles.processdView}>
              <TouchableOpacity
                ...
                onPress={() =>
                  this.props.navigation.navigate("AddSocial", { type: type })
                }
              >
