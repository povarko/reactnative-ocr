      ...
      <ImageBackground style={styles.container}>
          <SafeAreaView>
            ...
            {isEmpty === true && (
              <TouchableOpacity
                activeOpacity={0.8}
                style={{alignItems: 'center', margin: 20, backgroundColor: "#f3f3f3", height: 160, borderRadius: 20}}
                // style={styles.proceedButtonView}
                // onPress={() => this.goToProcess()}
              >
                {/* <Image source={Icons.addreceipt} style={{marginTop: 30}}/>                 */}
                <Text style={{color: "#00eaff", width: "100%", textAlign: 'center', fontSize: 26, marginTop: 30}}>
                    +
                </Text>
                <Text style={{color: "#000000", width: "100%", fontSize: 18, fontWeight: "bold", marginTop: 5, marginBottom: 5, textAlign: 'center'}}>
                  Add Receipt
                </Text>
                <Text style={{color: "#868686", width: "100%", alignItems: 'center', textAlign: 'center'}}>
            ...
            {isEmpty === true && (
              ...
              {isEmpty === false && (
                <View style={styles.overview}>                
                  ...
                  <Text style={{color: "#000000", width: "100%", fontSize: 16, fontWeight: "bold", marginTop: 5, marginBottom: 5}}>
                    June 2020
                  </Text>
                  <Text style={{color: "#000", width: "100%", fontSize: 24, fontWeight: "bold"}}>
                    $1765.90
                  </Text>
                </View>
              )}
            ...
            {isEmpty === false && (
              ...
              <View style={{height: 50, backgroundColor: '#f9f9f9', alignItems: 'center'}}>
                <View style={styles.line} />
                <TouchableOpacity
                  activeOpacity={0.8}
                  style={{flex: 1}}
