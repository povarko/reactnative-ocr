...
class IssueSetupTeam2Screen extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
        ...
        <ScrollView style={styles.content}>
          ...
          <View style={styles.bioContent}>
            <View style={{ marginTop: 10 }}>
              <Input
                placeholder="Enter your prefered home location"
              ...
              />
              <Image source={Images.maps} style={styles.maps} />
            </View>
          </View>
        </ScrollView>
      </View>
          ...
          <View style={{ flex: 1 }}>
            ...
            <View style={styles.processdView}>
              <TouchableOpacity
                ...
                onPress={() =>
                  this.props.navigation.navigate("IssueSetupTeam3")
                }
              >
...
export default IssueSetupTeam2Screen;
